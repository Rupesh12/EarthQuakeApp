...
public final class QueryUtil {
    ...
    /**
     * No one should be able to create the object of this class, only ment to have
     * static variables and methods which can be directly accessed from the class name.
     */
    ...
    public static List<Earthquake> extractEarthquakes(String jsonResponse){
        ...
        try{
            ...
            for(int i = 0 ; i<jsonArray.length() ;i++){
                ...
                long timeinmilli = prop.getLong("time") ;

                earthquakes.add(new Earthquake(mag,place,timeinmilli,url));
            }

        }catch (JSONException e){
            Log.e("QueryUtils", "Hudson we have a problem with JSON Parsing",e) ;
